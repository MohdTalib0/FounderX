-- Migration 020: Update Starter plan limits to match new pricing
--
-- Starter tier limits were rebalanced after moving to a quality-gated model
-- (refine + regenerate + voice samples are the value, not raw volume).
--
-- Plan limits:
--   free:    posts=12,  comments=15,  rewrites=5   (unchanged)
--   starter: posts=40,  comments=50,  rewrites=20  (was 80/100/40)
